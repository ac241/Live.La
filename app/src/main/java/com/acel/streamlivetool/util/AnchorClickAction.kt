...
import com.acel.streamlivetool.value.PreferenceVariable.itemClickAction
import com.acel.streamlivetool.value.PreferenceVariable.secondaryButtonClickAction
...
object AnchorClickAction {
    ...
    fun itemClick(context: Context, anchor: Anchor, list: List<Anchor>) {
        actionWhenClick(context, itemClickAction.value, anchor, list)
    }

    fun secondBtnClick(context: Context, anchor: Anchor, list: List<Anchor>) {
        actionWhenClick(context, secondaryButtonClickAction.value, anchor, list)
    }
