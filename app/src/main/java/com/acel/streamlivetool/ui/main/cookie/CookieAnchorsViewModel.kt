...
class CookieAnchorsViewModel(private val cookieAnchorsFragment: CookieAnchorsFragment) :
    ViewModel() {
    class ViewModeFactory(private val cookieAnchorsFragment: CookieAnchorsFragment) :
    ...
    internal fun getAnchors() {
        MainExecutor.execute {
            val anchorsCookieMode =
                cookieAnchorsFragment.platform?.let {
